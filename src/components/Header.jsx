    ...
    <Box sx={{ flexGrow: 1 }}>
        ...
        <Toolbar>
          ...
          >
            <Box
              ...
              alt="Park Me"
              src="https://see.fontimg.com/api/renderfont4/mLE25/eyJyIjoiZnMiLCJoIjo2NSwidyI6MTUwMCwiZnMiOjQzLCJmZ2MiOiIjOTgxMzI2IiwiYmdjIjoiI0ZGRkZGRiIsInQiOjF9/RG9jdG9yIEFwcG9pbnRtZW50/blacknorthdemo.png"
            />
          </IconButton>
      ...
      >
        ...
        <DialogContent>
          ...
          <br />
          <DialogContentText id="alert-dialog-description">
            Email : helpdesk@doctorappointment.com
            <br />
            Email : doctorappointment@hotmail.com
          </DialogContentText>
          <br />
          <br />
          <DialogContentText id="alert-dialog-description">
